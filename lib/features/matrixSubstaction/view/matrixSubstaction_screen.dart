...
class MatrixSubstraction extends StatefulWidget {
  const MatrixSubstraction({Key? key}) : super(key: key);

  @override
  _MatrixSubstractionState createState() => _MatrixSubstractionState();
}

class _MatrixSubstractionState extends State<MatrixSubstraction> {
            ...
            ElevatedButton(
              onPressed: () {
                ...
                for (int i = 0; i < matrix1.length; i++) {
                  ...
                  result.add(row);
                  Navigator.of(context).pushNamed('/matrix_substraction',
